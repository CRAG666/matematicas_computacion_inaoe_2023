...
class ImageCompressionApp:
    ...
    def create_columns(self):
        ...
        self.column1.grid(row=0, column=0, padx=5, pady=5, sticky="nsew")
        ...
        self.column4.grid(row=0, column=3, padx=5, pady=5, sticky="nsew")
    ...
    def create_buttons(self):
        # Agrega los botones en la parte superior
        self.button_frame = ttk.Frame(self.frame)
        self.button_frame.grid(row=1, column=0, columnspan=4, padx=5, pady=10)
        ...
        self.svd_button.grid(row=0, column=1, padx=5)
        ...
        self.n_components_label.grid(row=0, column=3, padx=5)

        self.n_components_entry = ttk.Entry(self.button_frame)
        self.n_components_entry.grid(row=0, column=4, padx=5)
